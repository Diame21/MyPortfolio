...
const ShopifyPage = () => {
    ...
    // const goToAnotherLink = () => {
    //     navigate('/todo')
    // }

    return (
        <>
            {/* <Link onClick={goToAnotherLink}>go to do</Link> */}
            ...
            {
                showForm &&
                <form onSubmit={handleSubmit} className="flex flex-col w-[30%] mx-[auto] mt-9 space-y-5 text-center bg-[#0A174E] p-5 ">
            ...
            {
                products.length > 0 ?
                    <div className='flex flex-wrap flex-row ml-7 mb-4 '>
